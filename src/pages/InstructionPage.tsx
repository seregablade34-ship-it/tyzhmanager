    ...
    <div className="p-4 md:p-6 max-w-3xl mx-auto space-y-4 pb-12">
      ...
      <Section icon="⚖️" title="Оценка целей">
        <p className="text-text-light text-sm leading-relaxed mb-3">
          Набор из 3 инструментов для анализа и приоритизации целей.
        </p>
        <ul className="space-y-2 text-text text-sm">
          <li className="flex gap-2">
            <span>🔲</span>
            <span>
              <strong>Квадрат Декарта</strong> — 4 вопроса помогут увидеть
              цель со всех сторон: что будет / не будет, если сделаю / не сделаю.
            </span>
          </li>
          <li className="flex gap-2">
            <span>🎯</span>
            <span>
              <strong>Метод 3П</strong> — авторская методика определения
              приоритета: Приближение, Последствия, Профит. Быстрый фильтр ДА/НЕТ.
            </span>
          </li>
          <li className="flex gap-2">
            <span>🧠</span>
            <span>
              <strong>Мини-самокоучинг</strong> — авторский подход: 10 вопросов
              для глубокой проработки цели. Помогает понять «зачем» и найти мотивацию.
            </span>
          </li>
        </ul>
      </Section>
