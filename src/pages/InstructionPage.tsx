...
{/* ══════ ОБНОВЛЕНИЕ ПРИЛОЖЕНИЯ ══════ */}
      ...
      <Section icon="🪜" title="Экшен-каскадирование">
        <p className="text-text-light text-sm leading-relaxed">
          Инструмент декомпозиции целей. Выберите цель — и разбейте её
          на конкретные шаги. Каждый шаг можно дробить дальше на подшаги,
          создавая дерево задач от крупных к мелким. Можно импортировать
          задачи из «Стратегии 5 лет» или «Целей на год». Отмечайте
          выполненные шаги и отслеживайте общий прогресс.
        </p>
      </Section>

      <Section icon="🧩" title="PP SMART">
        <p className="text-text-light text-sm leading-relaxed">
          Авторская методика постановки целей. 5 вопросов (Что? Сколько?
          Как? Зачем? Когда?) — и система автоматически формулирует
          вашу цель в прошедшем времени, как уже свершившийся факт.
        </p>
      </Section>

      <Section icon="🏆" title="Достижения">
        <p className="text-text-light text-sm leading-relaxed">
          Система бейджей и рангов. Получайте значки за первые цели,
          серии продуктивных дней (комбо), использование инструментов.
          Делитесь достижениями — скачивайте красивые карточки в формате
          PNG.
        </p>
      </Section>
      ...
      <Section icon="📊" title="Статистика">
        <p className="text-text-light text-sm leading-relaxed">
          ...
          по целям. Переключайте периоды: сегодня, неделя, месяц.
        </p>
      </Section>
